...
public class ServletCreationCompte extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			msg = "* Pseudo déjà pris merci dans choisir un autre.";
			...
			try {
				...
				msg = "* Adresse email déjà existante merci dans utilisé une autre.";
				doGet(request, response);
			} catch (BLLException e) {

				if (!confirmSaisie.equals(mot_de_passe)) {

					// mdp et confirmation différents //

					msg = "* Le mot de passe et la confirmation ne correspondent pas, veuillez le resaisir";
					doGet(request, response);
